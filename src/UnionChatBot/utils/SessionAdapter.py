...
def setting_up(folder_id: str,
    ...
    chat_manager = ChatHistoryManager(redis_host=redis_host,
...
def get_prompt(path_to_prompts: str = "./prompts") -> str:
    with open(f'{path_to_prompts}/WorkerUnionDefault.txt', 'r', encoding='utf-8') as file:
